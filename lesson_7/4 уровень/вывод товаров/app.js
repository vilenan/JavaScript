...
let buttonElemes = document.querySelectorAll('button');
let productEl = document.querySelector('.products');
buttonElemes.forEach(function (button) {
...
function showCategory(category) {
    let markupDiv = "";
    const itemsOfCategory = products[category];
   
    itemsOfCategory.forEach(function (item) {
        markupDiv += getProductMarkup(item);
    });
    productEl.insertAdjacentHTML("afterbegin", markupDiv);
}
